          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="{{route('admin.reset.password')}}" method="POST">
                  @csrf
                  ...
                  <div class="form-group">
                    <input type="password" name="password" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Enter new password" required>
                  </div>
                  <div class="form-group">
